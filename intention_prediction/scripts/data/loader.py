...
from sgan.data.trajectories import JAADDataset, JAADLoader, JAADcollate, LausanneDataset, LausanneLoader, Lausannecollate
...
def data_loader(args, path, dtype):
    ...
    if(dtype == "val"):
        df = LausanneDataset(path, args.obs_len, args.obs_len, args.timestep)
